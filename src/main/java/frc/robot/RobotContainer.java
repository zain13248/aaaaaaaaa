...
public class RobotContainer {
    ...
    private final AutoAlignToAprilTagCommand alignCommand = new AutoAlignToAprilTagCommand(drivetrain, visionSubsystem);
    ...
    //    drivetrain.setDefaultCommand(drivetrain.applyRequest(() -> new SwerveRequest.FieldCentric()));
        ...
        new JoystickButton(joystick, 1).onTrue(alignCommand);
