...
public class AlgaeFloor extends Command {
    ...
    public AlgaeFloor(ElevatorSubsystem elevator, EndEffector endEffector) {
        this.elevator = elevator;
        this.endEffector = endEffector;
        this.targetPositionElevator = Constants.ElevatorConstants.ELEVATOR_REEF_1_POSITION + Can90_Elevator;
        this.targetPositionEndEffector = Constants.EndEffector.EndEffector_REEF_1_POSITION + Can90_endEffector;
