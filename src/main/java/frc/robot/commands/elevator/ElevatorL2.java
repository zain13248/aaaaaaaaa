...
public class ElevatorL2 extends Command {
    ...
    public ElevatorL2(ElevatorSubsystem elevator, EndEffector endEffector) {
        this.elevator = elevator;
        this.endEffector = endEffector;
        this.targetPositionElevator = Constants.ElevatorConstants.ELEVATOR_REEF_2_POSITION + Can90_Elevator;
