...
public class ElevatorL3 extends Command {
    ...
    public ElevatorL3(ElevatorSubsystem elevator, EndEffector endEffector) {
        this.elevator = elevator;
        this.endEffector = endEffector;
        this.targetPositionElevator = Constants.ElevatorConstants.ELEVATOR_REEF_3_POSITION + Can90_Elevator;
        this.targetPositionEndEffector = Constants.EndEffector.EndEffector_STARTING_POSITION + Can90_endEffector;
