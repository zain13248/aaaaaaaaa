...
public class ElevatorAlgaeL2 extends Command {
    ...
    public ElevatorAlgaeL2(ElevatorSubsystem elevator, EndEffector endEffector) {
        this.elevator = elevator;
        this.endEffector = endEffector;
        this.targetPositionElevator = Constants.ElevatorConstants.ELEVATOR_ALGAE_2_POSITION + Can90_Elevator;
